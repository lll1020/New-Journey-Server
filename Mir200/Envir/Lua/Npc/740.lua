...
local DROP_RULES = {{map = "冻魂冰窟", item = "上古玄冰", rate = 5000}, {map = "冻魂冰窟", item = "千年陨铁", rate = 3500}, {map = "冻魂冰窟", item = "极寒之心", rate = 8000}, {map = "冻魂冰窟", item = "寒冰剑诀", rate = 10000, require_craft = true}}
