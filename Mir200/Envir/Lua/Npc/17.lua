...
function npc.link(play, npcid, p2, p3, msgData)
    if p2 == 1 then
        ...
        if changemoney(play,3,"-",1000000,"货币兑换",true) then
            changemoney(play,4,"+",10000,"货币兑换",true)
    ...
    elseif p2 == 2 then
        ...
        if changemoney(play,1,"-",1000000,"货币兑换",true) then
            changemoney(play,2,"+",10000,"货币兑换",true)
            setplaydef(play,VarCfg.J_hbdh[2], getplaydef(play,VarCfg.J_hbdh[2]) + 1)
            sendmsg(play,1,'{"Msg":"<font color=\'#ff7700\'>[货币兑换]</font><font color=\'#00ff00\'>兑换成功...</font>","Type":9}')
            sendluamsg(play,100,npcid,1,0,'{"hbdh1":'..getplaydef(play,VarCfg.J_hbdh[1])..',"hbdh2":'..getplaydef(play,VarCfg.J_hbdh[2])..'}')

        else
            sendmsg(play,1,'{"Msg":"<font color=\'#ff7700\'>[货币兑换]</font><font color=\'#ff0000\'>绑定金币不足...</font>","Type":9}')
        end
    -- elseif p2 == 3 then
    ...
    --         sendmsg(play,1,'{"Msg":"<font color=\'#ff7700\'>[货币兑换]</font><font color=\'#00ff00\'>兑换成功...</font>","Type":9}')
    --     else
    --         sendmsg(play,1,'{"Msg":"<font color=\'#ff7700\'>[货币兑换]</font><font color=\'#ff0000\'>灵石不足...</font>","Type":9}')
    --     end
    -- elseif p2 == 4 then
    ...
    --         sendmsg(play,1,'{"Msg":"<font color=\'#ff7700\'>[货币兑换]</font><font color=\'#00ff00\'>兑换成功...</font>","Type":9}')
    --     else
    --         sendmsg(play,1,'{"Msg":"<font color=\'#ff7700\'>[货币兑换]</font><font color=\'#ff0000\'>绑定灵石不足...</font>","Type":9}')
    --     end
    end
end
