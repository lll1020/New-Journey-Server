...
local _config = {
    ...
    [225] = {"聊斋志异",100,100,nil,nil,5, mob_name = "≮书外真妖·异闻尊≯", mob_shape = 16121, min_map = "000100"},
    [226] = {"敦煌遗梦",100,100,nil,nil,5, mob_name = "≮文明余晖·敦煌尊≯", mob_shape = 16121, min_map = "000100"},
    [227] = {"世界禁墟",100,100,nil,nil,5, mob_name = "≮文明终点·禁墟尊≯", mob_shape = 16170, min_map = "000100"},
}
local _config_spa = {
    --{"地图名",x,y,限制fun,提示文字,所属大陆}
    [300] = {"虚妄山脉", 92, 50,nil,nil,3, mob_name = "★南境荒王★", mob_shape = 12057, min_map = "000100"},
    [301] = {"鬼嘲深渊", 273, 33,nil,nil,3, mob_name = "≮北寒碎霜王≯", mob_shape = 12059, min_map = "000100"},
    [302] = {"叹息旷野", 34, 41,nil,nil,3, mob_name = "「灰翼风痕主」", mob_shape = 12039, min_map = "000100"},
    [303] = {"禁忌之海", 33, 133,nil,nil,3, mob_name = "★西海古皇★[道法合一]", mob_shape = 12105, min_map = "000100"},
    ...
    [310] = {"黑风山", 158, 72,nil,nil,4, mob_name = "★黑风大王·裂山狂尊★", mob_shape = 16461, min_map = "000100"},
    [311] = {"黄风岭", 92, 368,nil,nil,4, mob_name = "≮黄风大圣·吞天妖尊≯", mob_shape = 16461, min_map = "000100"},
    [312] = {"女儿国", 161, 146,nil,nil,4, mob_name = "「红尘情劫·女国之主」", mob_shape = 16461, min_map = "000100"},
    [313] = {"通天河", 237, 39,nil,nil,4, mob_name = "≮通天河主·覆浪妖王≯", mob_shape = 16461, min_map = "000100"},
    [314] = {"狮驼岭", 17, 87,nil,nil,4, mob_name = "★狮驼三王·青狮★", mob_shape = 16461, min_map = "000100"},
    [315] = {"天竺山", 68, 66,nil,nil,4, mob_name = "≮梵天圣境·天竺尊主≯", mob_shape = 16461, min_map = "000100"},
