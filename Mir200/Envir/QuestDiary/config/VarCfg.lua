...
VarCfg["G_黑暗禁地状态"]           = "G9"                                                                          --黑暗禁地状态(0关闭/1开启)
VarCfg["G_保卫村庄状态"]           = "G10"                                                                         --保卫村庄状态(0关闭/1开启)
--引擎A变量
...
-- A11 记录血契开放提示上次广播的分钟桶。
VarCfg["A_血契之门公告"]          = "A11"                                                                          --血契之门最近一次公告时间桶
...
VarCfg["U_深渊次数"]      =    "U45"                                                                     --U深渊次数
VarCfg["U_藏宝图次数"]                          = "U46"                                                                          --藏宝图累计完成次数
VarCfg["U_攻沙积分跨服"]                     = "U48"                 --U_攻沙积分跨服
VarCfg["U_跨服积分"]                         = "U49"                 --跨服积分持久化货币
VarCfg["U_战斗力"]                          = "U176"
VarCfg["U_真实充值"]                          = "U225"
--收集物品任务用
--引擎B变量 --大数值
...
--个人标识
VarCfg.BS_huishou       =  {101,102,103,104,105}                                                                    --自动吃元宝,自动吃经验,自动捡物,自动回收开关
...
VarCfg["F_跨服攻沙是否领取"]                 = 800                --F_跨服攻沙是否领取
--引擎J变量
--个人J变量
...
VarCfg["J_聚宝盆积分"]      =    "J25"                                                                     --J_聚宝盆每日积分
VarCfg["J_醉意值"]      =    "J23"                                                                     --J_醉意值
VarCfg["J_是否领取沙奖励"]      =    "J24"                                                                     --J_是否领取沙奖励
--引擎Z变量
...
VarCfg["T_生肖守护"]           = "T53"                                                                         --T_生肖守护
VarCfg["T_时光之杖"]           = "T54"                                                                         --T_时光之杖
VarCfg["T_砍树系统"]           = "T55"                                                                         --T_砍树系统
VarCfg["T_物品使用记录"]           = "T56"                                                                         --T_物品使用记录
VarCfg["T_时光之杖等级"]           = "T57"                                                                         --T_时光之杖等级
VarCfg["T_物品掉落记录"]           = "T58"                                                                         --T_物品掉落记录
VarCfg["T_马上发财"]           = "T59"                                                                         --马上发财抽奖活动数据
VarCfg["T_天书试炼"]           = "T60"                                                                         --天书试炼数据
VarCfg["T_天书先天"]           = "T61"                                                                         --天书先天词条
VarCfg["T_古玩鉴定"]           = "T63"                                                                         --T_古玩鉴定--引擎变量 S
-- T64-T68 为六大陆新系统预留的持久化槽位。
    VarCfg["T_星象圣图"]           = "T64"                                                                         --T_星象圣图
VarCfg["T_世界符文"]           = "T65"                                                                         --T_世界符文
VarCfg["T_残魂商店"]           = "T66"                                                                         --T_残魂商店
VarCfg["T_血契之门"]           = "T67"                                                                         --T_血契之门
VarCfg["T_武器性格"]           = "T68"                                                                         --T_武器性格
VarCfg["T_保卫村庄"]           = "T69"                                                                         --T_保卫村庄
VarCfg["G_美食狂欢状态"]           = "G11"                                                                         --G_美食狂欢状态
VarCfg["A_美食狂欢json"]           = "A14"                                                                         --A_美食狂欢json
VarCfg["A_新区冲级json"]           = "A16"                                                                         --新区冲级全服名额记录
VarCfg["A_黄泉降世json"]           = "A17"                                                                         --聚宝盆禁器黄泉降世全服状态
VarCfg["T_美食狂欢"]           = "T70"                                                                         --T_美食狂欢
VarCfg["T_新区冲级"]           = "T71"                                                                         --新区冲级个人领取记录
VarCfg["T_登神之路"]           = "T72"                                                                         --登神之路  
VarCfg["T_称号等级奖励"]           = "T73"                                                                         --T_称号等级奖励
VarCfg.T_talent_tree                         = "T74"                  -- New talent tree state
