...
local _config = {
    ...
    [230] = {"冰川雪域",0,0,nil,nil,6, mob_name = "雪域冰王?寒魄", mob_shape = 16172, min_map = "028116", other_name = "冰川雪域"},
    [231] = {"森罗魔域",0,0,nil,nil,6, mob_name = "森罗魔主?灭世", mob_shape = 16173, min_map = "028769", other_name = "森罗魔域"},
    [232] = {"边关烽城",0,0,nil,nil,6, mob_name = "镇关大将军?烈锋", mob_shape = 16174, min_map = "028575", other_name = "边关烽城"},
    [233] = {"盛世古城",0,0,nil,nil,6, mob_name = "古城守护神?天佑 [神圣]", mob_shape = 16175, min_map = "027249", other_name = "盛世古城"},
