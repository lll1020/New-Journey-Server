...
local PET_ALL_THREE_STAR_TITLE = "一缕残魂可灭世"
...
local function _try_give_all_three_star_title(play, T_data)
    ...
    T_data = _ensure_pet_data(T_data or Player.getJsonTableByVar(play, VarCfg["T_灵兽"]))
    for i = 1, 5 do
    ...
    Player.sendmsgEx(play, "恭喜获得称号：|【" .. PET_ALL_THREE_STAR_TITLE .. "】#218|")
    return true
end
