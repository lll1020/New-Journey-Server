...
local function _build_snapshot(play, state)
    ...
    return {
        ...
        recharge_total = math.max(_toint(querymoney(play, 23)), _toint(getplaydef(play, VarCfg["U_真实充值"]))), xianfu_level = _toint(xianfu.level), xianfu_xianghua = _toint(xianfu.stats.xiangHua),
