...
local _mijing_cfg = {
    ...
    [87] = {name = "苍云秘境", map = "苍云秘境", x = 100, y = 100, need_desc = "至尊玩家赞助可进", need_titles = {"至尊玩家", "至尊玩家赞助"}, artifact = "苍云镜", title_item = "白云苍狗[可使用]", title_name = "白云苍狗"},
    [88] = {name = "若水秘境", map = "若水秘境", x = 100, y = 100, need_desc = "激活1条红色仙法", need_red_xianfa = 1, artifact = "若水灵珠", title_item = "上善若水[可使用]", title_name = "上善若水"},
    [89] = {name = "红尘秘境", map = "红尘秘境", x = 100, y = 100, need_desc = "激活3条红色仙法", need_red_xianfa = 3, artifact = "斩红尘", title_item = "看破红尘[可使用]", title_name = "看破红尘"},
