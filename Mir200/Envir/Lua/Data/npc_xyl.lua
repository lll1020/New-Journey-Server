            ...
            jq = {
                {
                    ...
                    jl = { { "剧情点", 1 }, { "仙法卷轴", 1 } },
                    fwdjy = function(play)
                        return _xyl_check_task(play, "进行天书强化1次")
                    end,
                    khdjy = function()
                        return true
                    end,
                ...
                },
                {
                    ...
                    jl = { { "剧情点", 1 } },
                    fwdjy = function(play)
                        return _xyl_check_task(play, "进行天书仙法抽取")
                    end,
                    khdjy = function()
                        return true
                    end,
                ...
                },
                {
                    ...
                    id = 999,
                    fwdjy = function(play)
                        return _xyl_check_task(play, "引导点击限时福利NPC")
                    end,
                    khdjy = function()
                        return true
                    end,
            ...
            jq = {
                {
                    ...
                    jl = { { "剧情点", 1 } },
                    fwdjy = function(play)
                        return _xyl_check_task(play, "装配火灵根至主灵根")
                    end,
                    khdjy = function()
                        return true
                    end,
                ...
                },
                {
                    ...
                    jl = { { "剧情点", 1 }, { "激活水灵根", 1 } },
                    fwdjy = function(play)
                        return _xyl_check_task(play, "引导天书使者洗炼一次")
                    end,
                    khdjy = function()
                        return true
                    end,
                ...
                },
                {
                    ...
                    id = 999,
                    fwdjy = function(play)
                        return _xyl_check_task(play, "装配水灵根至副灵根")
                    end,
                    khdjy = function()
                        return true
                    end,
                ...
                },
                {
                    ...
                    jl = { { "剧情点", 1 } },
                    fwdjy = function(play)
                        return _xyl_check_task(play, "装备强化1次")
                    end,
                    khdjy = function()
                        return true
                    end,
        ...
        },
        {
            jq = {
                ...
                },
                {
                    ...
                    id = 999,
                    fwdjy = function(play)
                        return _xyl_check_task(play, "查看江湖称号1次")
                    end,
                    khdjy = function()
                        return true
                    end,
                ...
                },
                {
                    ...
                    id = 999,
                    fwdjy = function(play)
                        return _xyl_check_task(play, "查看幸运增幅1次")
                    end,
                    khdjy = function()
                        return true
                    end,
                ...
                },
                {
                    ...
                    id = 999,
                    fwdjy = function(play)
                        return _xyl_check_task(play, "强化灵根1次")
                    end,
                    khdjy = function()
                        return true
                    end,
