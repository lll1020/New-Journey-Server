...
-- drop_hint: 莫高窟壁画上卷：1/1000 莫高窟壁画下卷：1/2500

local _cfg_key = "npc_706"
...
function npc.link(play,npcid,ew,aid)
    ...
    if getbaseinfo(play,3) ~= "莫高窟" and getbaseinfo(play,3) ~= "xtc" then
        Player.sendmsgEx(play, "请前往#57|【莫高窟】#249|完成后再提交#57")
