...
function Login_msg(play, id, msg, leve)
	...
	elseif id == 1 then -- 下地图提示语句
		Player.sendmsgEx(play, 2, '{"BColor":249,"FColor":255,"Msg":"<outline size=\'1\'><font color=\'#FFFF00\'>【地图打宝】：</font>玩家<font color=\'#00ff00\'>[' .. getbaseinfo(play, 1) .. ']</font>前往地图<font color=\'#00FFFF\'>[' .. getbaseinfo(play, 45) .. ']</font>开始探险之旅！</outline>","Type":1}')
	elseif id == 2 then -- 转生成功提示
		Player.sendmsgEx(play, 2, '{"BColor":249,"FColor":255,"Msg":"<outline size=\'1\'><font color=\'#FFFF00\'>【人物转生】：</font>玩家<font color=\'#00ff00\'>[' .. getbaseinfo(play, 1) .. ']</font>成功转生<font color=\'#00FFFF\'>[' .. msg .. ']</font>仙途畅通！</outline>","Type":1}')
	...
	elseif id == 5 then -- 轩辕剑，切割之斧提示
		Player.sendmsgEx(play, 2, '{"BColor":249,"FColor":255,"Msg":"<outline size=\'1\'><font color=\'#FFFF00\'>【' .. msg .. '晋升】：</font>玩家<font color=\'#00ff00\'>[' .. getbaseinfo(play, 1) .. ']</font>成功升级<font color=\'#00FFFF\'>[' .. msg .. ']</font>仙途畅通！</outline>","Type":1}')
	elseif id == 6 then -- 公用修炼提示
		Player.sendmsgEx(play, 2, '{"BColor":249,"FColor":255,"Msg":"<outline size=\'1\'><font color=\'#FFFF00\'>【' .. msg .. '晋升】：</font>玩家<font color=\'#00ff00\'>[' .. getbaseinfo(play, 1) .. ']</font>成功<font color=\'#00FFFF\'>[' .. msg .. leve .. '级]</font>仙途畅通！</outline>","Type":1}')
